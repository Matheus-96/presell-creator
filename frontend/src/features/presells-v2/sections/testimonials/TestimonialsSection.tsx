...
function TestimonialsSection({ props }: SectionComponentProps<TestimonialsProps>) {
  ...
  return (
    <section data-section="testimonials" className="w-full px-6 py-16">
              ...
              <div className="flex items-center gap-3">
                {item.avatarUrl ? (
                  ...
                  <div
                    ...
                    className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-dashed border-slate-300 bg-slate-100 text-xs text-slate-500"
                  >
